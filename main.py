...
# --- Blok Pengecekan dan Import Library ---
# Memberikan pesan error yang lebih jelas jika ada library yang hilang
try:
    ...
    print(f"[!] GAGAL: Terjadi error saat mengimpor library: {e}")
    print("[!] Sepertinya ada library yang belum ter-install.")
    print("[!] Pastikan Anda sudah mengaktifkan venv dan menjalankan perintah:")
    print("[!] pip install -r requirements.txt")
    sys.exit(1)

# --- Memeriksa Modul Lokal ---
# Pastikan struktur folder "Penyimpanan" dan "Temporary" sudah benar
try:
    ...
    print(f"[!] GAGAL: Gagal mengimpor modul lokal: {e}")
    print("[!] Pastikan struktur folder Anda (Penyimpanan/, Temporary/) sudah benar dan semua file .py yang dibutuhkan ada di dalamnya.")
    sys.exit(1)
